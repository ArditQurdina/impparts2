...
import { UMC1000_MACHINE, VERTICAL_MILLS_SECTION } from "./machinery-assets";

type UMC1000MachineSectionProps = {
  content: MachineryMessages["umc1000"];
};

export function UMC1000MachineSection({
  content,
}: UMC1000MachineSectionProps) {
  return (
    <section
      id="umc-1000"
      ...
      <Container>
        <div className="flex flex-col gap-10 sm:gap-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-8 lg:gap-y-6 xl:gap-y-8">
          ...
          <div className="relative flex items-end lg:col-span-6">
            <Image
              src="/images/flagship.webp"
              alt={`${UMC1000_MACHINE.imageAltName} — ${content.imageAltDescription}`}
              width={1200}
              height={1200}
              priority
          ...
          <div className="flex flex-col lg:col-span-6 lg:pt-1">
            ...
            <h3 className="mt-3 font-display uppercase leading-[0.85] tracking-tight text-4xl sm:text-5xl lg:text-5xl xl:text-6xl 2xl:text-7xl">
              {UMC1000_MACHINE.titleLine1}
              <br />
              {UMC1000_MACHINE.titleLine2}
            </h3>
